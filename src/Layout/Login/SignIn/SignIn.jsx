                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                                <div className="card-body">
                                    ...
                                    <div className="form-control mt-6">
                                        ...
                                        <input className="btn btn-outline  border-0 border-b-4 border-yellow-500 text-black hover:bg-yellow-500 hover:border-yellow-500 " type="submit" value='Sign up' />
                                    </div>
                                </div>
                            </form>
                        </div>
